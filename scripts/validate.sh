...
# Hook registration (exec form, matchers, SessionEnd removal) is covered by
# tests/test_hooks.sh, which exercises the real scripts instead of asserting
# on these strings.
if problems:
...
. "$SKILL/tests/test_placeholder.sh"
. "$SKILL/tests/test_quoting.sh"
. "$SKILL/tests/test_doc_claims.sh"
. "$SKILL/tests/test_guard_docs.sh"
. "$SKILL/tests/test_mutant_gaps.sh"
. "$SKILL/tests/test_caps.sh"
. "$SKILL/tests/test_interrupt.sh"
. "$SKILL/tests/test_mgaps.sh"
. "$SKILL/tests/test_testfix.sh"
. "$SKILL/tests/test_haiku.sh"
# ------------------------------------------------------------ 4. live runs
